...
export const env = {
  NODE_ENV: optional("NODE_ENV", "development"), PORT: parseInt(optional("PORT", "4000"), 10), APP_NAME: optional("APP_NAME", "MAX Auth"), APP_URL: optional("APP_URL", "http://localhost:4000"), FRONTEND_URL: optional("FRONTEND_URL", "http://localhost:3000"),
  ...
  COOKIE_DOMAIN: optional("COOKIE_DOMAIN", "localhost"), COOKIE_SECURE: optional("COOKIE_SECURE", "false") === "true", REFRESH_COOKIE_NAME: optional("REFRESH_COOKIE_NAME", "max_refresh_token"), CSRF_SECRET: required("CSRF_SECRET"),
  ...
  MAIL_FROM: optional("MAIL_FROM", "MAX Auth <no-reply@max-ai.name.ng>"), MAIL_PROVIDER: optional("MAIL_PROVIDER", "console"),

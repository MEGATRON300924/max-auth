...
export const env = {
  ...
  COOKIE_DOMAIN: optional("COOKIE_DOMAIN", "localhost"), COOKIE_SECURE: optional("COOKIE_SECURE", "false") === "true", COOKIE_SAME_SITE: optional("COOKIE_SAME_SITE", "strict") as "strict" | "lax" | "none", REFRESH_COOKIE_NAME: optional("REFRESH_COOKIE_NAME", "max_refresh_token"), CSRF_SECRET: required("CSRF_SECRET"),

...
export const env = {
  ...
  // Production spans the MAX subdomains, so the refresh cookie must be valid for them.
  // Keep local development scoped to localhost.
  COOKIE_DOMAIN: optional("COOKIE_DOMAIN", isProduction ? "max-ai.name.ng" : "localhost"),

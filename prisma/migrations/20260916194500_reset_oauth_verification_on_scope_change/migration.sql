...
BEGIN
  IF OLD.name IS DISTINCT FROM NEW.name
     OR OLD."redirectUris" IS DISTINCT FROM NEW."redirectUris"
     OR OLD.scopes IS DISTINCT FROM NEW.scopes THEN
...
AFTER UPDATE OF "name", "redirectUris", "scopes" ON "oauth_clients"
FOR EACH ROW
